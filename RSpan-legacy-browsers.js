...
function practiceSentenceLoopBegin(practiceSentenceLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  practiceSentence.forEach(function() {
...
function sentenceTrialLoopBegin(sentenceTrialLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  sentenceTrial.forEach(function() {
...
function sentence2RoutineBegin(snapshot) {
  return function () {
    ...
    sentence2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function sentenceResponseTrialRoutineBegin(snapshot) {
  return function () {
    ...
    sentenceResponseTrialComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function letterTrial_2RoutineBegin(snapshot) {
  return function () {
    ...
    letterTrial_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
